          ...
          Center(
            child: ListView(
              ...
              children: [
                ...
                Column(
                  children: [
                    Text(getFormattedDate(_provider.currentModel!.dt!, 'EEE MMM dd, yyyy'), style: TextStyle(fontSize: 16),),
                    Text('${_provider.currentModel!.name}, ${_provider.currentModel!.sys!.country!}', style: TextStyle(fontSize: 22),),
                    Text('${_provider.currentModel!.main!.temp!.toStringAsFixed(1)}\u00B0', style: TextStyle(fontSize: 80),),
